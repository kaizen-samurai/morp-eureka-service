package org.ks.trial.morp.eureka.constants;
...
public class Constants {
    ...
    //FORMATTERS
    public static final String HEROKU_SWAGGER_UI_URL = "https://%s:%s/swagger-ui/index.html";
    public static final String SWAGGER_UI_URL = "http://%s:%s/swagger-ui/index.html";
    public static final String HOST_URL = "https://%s:%s";
